<x-guest-layout>
    ...
    <form method="POST" action="/login">
        ...
        <div class="flex items-center justify-center mt-6 space-x-6 ">
            ...
            <a class="underline text-sm text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
                Register
            </a>
        </div>
    </form>
