        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="config('app.url') . '/category/men'" :active="request()->routeIs('men')">
                        {{ __('Men') }}
                    </x-nav-link>
                    <x-nav-link :href="config('app.url') . '/category/women'" :active="request()->routeIs('women')">
                        {{ __('Women') }}
                    </x-nav-link>
                    <x-nav-link :href="config('app.url') . '/category/accessories'" :active="request()->routeIs('accessories')">
                        {{ __('Accessories') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ config('app.url') . '/logout' }}">
                            @csrf
                            <x-dropdown-link :href="config('app.url') . '/logout'"
